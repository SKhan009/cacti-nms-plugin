...
<main class="nms-shell nms-config-shell">
	...
	<?php } else { ?>
	<section class="nms-panel nms-config-panel"><div class="nms-config-bar"><div><h2>Operational groups</h2><p>Create labels such as LAN, WAN or Power infrastructure. Assign memberships in Edit device; one device can belong to multiple groups. Groups do not change its category or template.</p></div></div>
