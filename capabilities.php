...
$device_capabilities = $capability_device ? nms_device_capabilities($capability_device) : array('capabilities' => array(), 'methods' => array());
...
require($config['base_path'] . '/plugins/nms/templates/capabilities.php');
