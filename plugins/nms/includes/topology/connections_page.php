...
<button class="nms-catalog-button" type="submit">Save connection</button> <a href="topology.php?tab=connections">Cancel</a>
</form><?php } ?>
<section class="nms-panel"><div class="nms-panel-head"><h2>Manually configured connections</h2></div><form method="get" class="nms-connection-form"><input type="hidden" name="tab" value="connections"><label>Find connection <input type="search" name="search" value="<?php print nms_h($search); ?>" placeholder="Device, type or label"></label> <button class="nms-catalog-button" type="submit">Filter</button> <a href="topology.php?tab=connections">Reset</a></form><div class="nms-catalog-scroll"><table class="nms-table"><thead><tr><th>Device A / interface</th><th>Device B / interface</th><th>Type / label</th><th>Configured Mbps</th><th>Actions</th></tr></thead><tbody>
