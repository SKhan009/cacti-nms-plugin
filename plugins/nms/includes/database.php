...
function nms_apply_database_schema()
{
 ...
 KEY host_id (host_id)
	...
	nms_category_execute("INSERT INTO plugin_nms_meta (meta_key, meta_value, updated_at)
		VALUES ('nms_schema_version', '1.10.92', NOW()) ON DUPLICATE KEY UPDATE meta_value = VALUES(meta_value), updated_at = NOW()");
}
...
function nms_drop_database()
{
	...
	db_execute("DROP TABLE IF EXISTS plugin_nms_link_classification");
