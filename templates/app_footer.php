	...
	<script src="<?php print nms_h($nms_asset_base . 'js/nms-pagination.js?v=1.9.15'); ?>"></script>
	<script src="<?php print nms_h($nms_asset_base . 'js/nms-tooltips.js?v=1.9.15'); ?>"></script>
</body>
</html>
