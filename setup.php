...
function plugin_nms_install() {
	...
	api_plugin_register_realm('nms', 'nms.php', 'View and Manage NMS Faults', 1);
...
function nms_page_head() {
	...
	if (get_current_page() === 'nms.php') {
		print '<link rel="stylesheet" href="' . html_escape($config['url_path'] . 'plugins/nms/css/nms-v1.1.css?v=1.5.0') . '">';
	}
}
