...
(/** Initialize shared contextual help, tooltip positioning, and dynamic-content enhancement. */ function () {
	...
	var fieldHelp = {
		manual_serial_number: 'Operator-entered serial stored in NMS only. It does not replace a live SNMP value or change the fault baseline.',
		...
		graph_style: 'All graph item types from Cacti core. The form shows the settings for the selected type.',
		stack_source_id: 'Reading drawn first as the base for an AREA:STACK or LINE:STACK item.',
		item_value: 'Horizontal rule value, vertical rule Unix timestamp, or tick fraction, depending on the item type.',
		line_width: 'Line thickness in pixels. Leave blank to use the selected LINE type default.',
		...
		textalign: 'Alignment for subsequent legend text; TEXTALIGN itself does not draw a line.',
		...
		category_id: 'Equipment category suggested for devices created from this imported template. Independent of Cacti trees.',
		equipment_category_id: 'Equipment category controls this device’s NMS rule scope. Cacti site, tree membership and template class remain separate.',
